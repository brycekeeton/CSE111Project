...
---- ADD RECOMMENDATIONS
---- EXAMPLES
-- #3: Tashi wants to add Games for xbox reviewed by Admin users before 2016 to their Recommendations
INSERT INTO Recommendation (rc_username, rc_recID, rc_gameID, rc_status, rc_comments)
...
-- #4: 12345 wants to add Adventure games for xbox whose average reviews after 2016 are > 4 to their Recommendations
INSERT INTO Recommendation (rc_username, rc_recID, rc_gameID, rc_status, rc_comments)
...
---- EXAMPLES
-- #5: View top 5 games of all time, by rating then by review count then alphabetically
